...
class EmbeddingCache:
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            cls._instance.cache = {} # Format: {member_id: {"name": str, "embedding": np.ndarray}}
    ...
    def load_embeddings(self):
        ...
        members = members_collection.find({}, {"member_id": 1, "name": 1, "embedding": 1})
    ...
    def add_to_cache(self, member_id: str, name: str, embedding: list):
